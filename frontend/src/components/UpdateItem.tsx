...
export default function UpdateItem({ title, chapter, chapterHref, novelHref, hasImage }: UpdateItemProps) {
  return (
    <div className="flex gap-3 py-2 border-b border-[#1e1e3a] last:border-0">
      {hasImage && (
        <div className="w-10 h-14 rounded bg-[#1e1e3a] flex-shrink-0 flex items-center justify-center">
