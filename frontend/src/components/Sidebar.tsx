...
export default function Sidebar() {
  ...
  return (
    <aside className={`hidden lg:flex fixed left-0 top-0 h-full ${collapsed ? "w-16" : "w-64"} flex-col bg-card border-r border-line z-50 shadow-2xl shadow-black/50 transition-all duration-300`}>
      <div className="px-6 pt-6 pb-4 flex items-center justify-between">
        ...
        <button
          onClick={toggle}
          className="text-gray-500 hover:text-white transition-colors p-1 rounded-lg hover:bg-card-hover"
