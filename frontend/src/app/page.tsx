  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 pt-20 pb-16 md:pt-28 md:pb-20 text-center relative z-10">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            ReadLab is a free reading platform for machine-translated light novels from raw sources.
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">Why Read on ReadLab?</h2>
