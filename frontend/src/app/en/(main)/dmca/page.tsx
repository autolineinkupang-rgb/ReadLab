  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <Card className="p-8 space-y-4 text-sm text-gray-300 leading-relaxed">
        <p>ReadLab respects the intellectual property rights of others and expects its users to do the same. In accordance with the Digital Millennium Copyright Act (DMCA), we will respond promptly to notices of alleged copyright infringement.</p>
        ...
        <p>Please contact us at <a href="mailto:your-email@example.com" className="text-violet-400 hover:text-violet-300">your-email@example.com</a> for DMCA-related inquiries.</p>
      </Card>
    </div>
  );
}
