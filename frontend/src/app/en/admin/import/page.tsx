      ...
      {results.length > 0 && (
        <div className="space-y-3">
          {results.map((r) => (
            ...
            >
              {r.image ? (
                <img src={r.image} alt="" className="w-12 h-16 rounded-lg object-cover bg-[#1e1e3a]" />
              ) : (
                <div className="w-12 h-16 rounded-lg bg-[#1e1e3a] flex items-center justify-center">
              ...
              <button
                ...
                className="shrink-0 px-4 py-2 bg-[#2193b0] hover:bg-[#1a7a94] disabled:opacity-50 text-white text-sm rounded-lg transition-colors"
              >
