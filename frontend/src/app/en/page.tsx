...
const MOCK_NEW = [
  { title: "Having Dinner with His Brother, the Cold and Aloof Tycoon Becomes Addicted to His Doting Affections", genre: "romance", chapters: 135, href: "/en/novel/1" },
  { title: "Corpse Puppet Phoenix Girl", genre: "adult", chapters: 242, href: "/en/novel/2" },
  { title: "Reborn As the Little Delicate Wife of the Domineering Ceo", genre: "romance", chapters: 378, href: "/en/novel/3" },
  { title: "The Corpse Family is Heavy", genre: "action", chapters: 252, href: "/en/novel/4" },
  { title: "Can You Please Comfort Me?", genre: "drama", chapters: 149, href: "/en/novel/5" },
  { title: "First-rank Di Consort", genre: "historical", chapters: 387, href: "/en/novel/6" },
  { title: "I am the Crown Prince of the Ming Dynasty", genre: "action", chapters: 1592, href: "/en/novel/7" },
  { title: "The Legend of the Mountain and Sea Demon Subduing", genre: "action", chapters: 1522, href: "/en/novel/8" },
  { title: "Don't Be Too Wild", genre: "romance", chapters: 160, href: "/en/novel/9" },
  { title: "The Villious Prince is Three", genre: "adult", chapters: 281, href: "/en/novel/10" },
];

const MOCK_RANKING = [
  { rank: 1, title: "Question and Answer Douluo: Tang San's Time Travel Revealed, Tang Hao Breaks Through Defense", views: "167,204", rating: "1.7", href: "/en/novel/11" },
  { rank: 2, title: "Douluo Continent: Taking Tang San As a Disciple, with a Ten-thousand-fold Return for Teaching Him", views: "61,300", rating: "2.0", href: "/en/novel/12" },
  { rank: 3, title: "Lord: God-tier Attribute, Recruits Fallen Angels of Original Sin", views: "50,895", rating: "3.3", href: "/en/novel/13" },
  { rank: 4, title: "I Just Started High School, But the System Insists I'm an Emperor in My Twilight Years", views: "50,315", rating: "1.9", href: "/en/novel/14" },
  { rank: 5, title: "Football: I See Weaknesses!", views: "41,170", rating: "1.8", href: "/en/novel/15" },
];
...
const MOCK_RECOMMENDATIONS = [
  { title: "Question and Answer Douluo: Tang San's Time Travel Revealed, Tang Hao Breaks Through Defense", genre: "action", rating: "1.7", chapters: 372, href: "/en/novel/11" },
  { title: "Douluo Continent: Taking Tang San As a Disciple, with a Ten-thousand-fold Return for Teaching Him", genre: "action", rating: "2.0", chapters: 284, href: "/en/novel/12" },
  { title: "I Just Started High School, But the System Insists I'm an Emperor in My Twilight Years", genre: "fantasy", rating: "1.9", chapters: 156, href: "/en/novel/14" },
  { title: "All Heavens: My Dantian is a Universe in Its Own", genre: "action", rating: "3.2", chapters: 412, href: "/en/novel/16" },
  { title: "Pretending to Be the Villain, All I Want is to Die at Naruto's Hands", genre: "action", rating: "2.8", chapters: 98, href: "/en/novel/17" },
  { title: "On the Day the Empress Sentenced Me to Death, the System Granted Me Emperor Level Cultivation", genre: "fantasy", rating: "3.5", chapters: 203, href: "/en/novel/18" },
];

const MOCK_UPDATES = [
  { title: "Reborn in 2002, I'm Carrying a Huawei Phone", chapter: "#184 Chapter 184: 4,000 Units Sold in the First Phase", chapterHref: "/en/novel/19/chapter-184", novelHref: "/en/novel/19", hasImage: false },
  { title: "Only After Ascending to Heaven Did I Realize That This Was Journey to the West", chapter: "#190 Chapter 190: Each Goes Their Own Way!", chapterHref: "/en/novel/20/chapter-190", novelHref: "/en/novel/20", hasImage: true },
  { title: "Douluo: Starting with the Role of a Born God of Strength", chapter: "#80 Chapter 80: False Accusation!", chapterHref: "/en/novel/21/chapter-80", novelHref: "/en/novel/21", hasImage: true },
  { title: "World War II Began with Preparations in Britain", chapter: "#102 Chapter 102: The Power of Financial Magic", chapterHref: "/en/novel/22/chapter-102", novelHref: "/en/novel/22", hasImage: true },
  { title: "From Dandelion to Evolution Into Dandelion Tree", chapter: "#254 Chapter 254: One in Ten Thousand Power", chapterHref: "/en/novel/23/chapter-254", novelHref: "/en/novel/23", hasImage: true },
  { title: "Upscale Residential Area Ahead, No Impostors Allowed", chapter: "#311 Chapter 311: The Immortal Under the Mask", chapterHref: "/en/novel/24/chapter-311", novelHref: "/en/novel/24", hasImage: true },
];
...
const MOCK_RANDOM = [
  ...
  { title: "Wuxia Crossover: Sweeping the Heavens, Fun Fun Fun Fun Fun Fun Fun", genre: "action", chapters: 501, rating: "2.5", href: "/en/novel/27" },
...
const MOCK_SPENDERS = [
  { name: "Mega_bells", tickets: "3,569.76", href: "/en/profile/1" },
  { name: "StandardCrystal", tickets: "2,907.17", href: "/en/profile/2" },
  { name: "Alpha2", tickets: "2,693.07", href: "/en/profile/3" },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-10">
      ...
      <div className="bg-gradient-to-r from-violet-900/40 to-purple-900/40 border border-violet-800/30 rounded-xl p-6 text-center">
        ...
        <Link href="/en/news/428" className="inline-block mt-2 px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white text-sm rounded-lg transition-colors">
          Check Results
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-2">
          <SectionHeader title="Trending" href="/en/trending" />
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {MOCK_TRENDING.map((title, i) => (
          ...
          <div className="mt-6 bg-[#12122a] border border-[#1e1e3a] rounded-xl p-5">
            <div className="flex gap-4">
              ...
              <div className="min-w-0 flex-1">
                <Link href="/en/novel/11/naruto-konoha-wood-release" className="text-base font-semibold text-white hover:text-violet-400 transition-colors line-clamp-2">
                  Naruto: In Konoha Village, I Awakened Wood Release at the Start
                </Link>
                ...
                <Link
                  href="/en/novel/11/naruto-konoha-wood-release/continue"
      ...
      <section>
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
          {MOCK_RECOMMENDATIONS.map((novel, i) => (
        ...
        <div className="mt-4 bg-[#12122a] border border-[#1e1e3a] rounded-xl p-5">
          <div className="flex gap-4">
            ...
            <div className="min-w-0 flex-1">
              <Link href="/en/novel/1/qa-douluo" className="text-base font-semibold text-white hover:text-violet-400 transition-colors line-clamp-2">
                Question and Answer Douluo: Tang San&apos;s Time Travel Revealed, Tang Hao Breaks Through Defense
              </Link>
              <div className="flex items-center gap-3 mt-1 text-sm text-gray-400">
                <span>★ 1.7</span>
              ...
              <Link
                href="/en/novel/1/qa-douluo/continue"
                className="inline-block mt-3 px-4 py-1.5 bg-violet-600 hover:bg-violet-700 text-white text-sm rounded-lg transition-colors"
              >
                START READING
              </Link>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="bg-[#12122a] border border-[#1e1e3a] rounded-xl p-4 space-y-3">
              <Link href="/en/news/428" className="block text-sm text-gray-200 hover:text-violet-400 transition-colors">🎉 16th Giveaway Winners 🎉</Link>
              <Link href="/en/news/427" className="block text-sm text-gray-200 hover:text-violet-400 transition-colors">🎉 Our 16th Giveaway is LIVE! 🎉</Link>
              <Link href="/en/news/426" className="block text-sm text-gray-200 hover:text-violet-400 transition-colors">Version 1.13.3 - New Source Management & Bug Fixes!</Link>
            </div>
          </div>
